...
function checkFFmpegInstallation() {
    if (!fs.existsSync(ffmpegPath) || !fs.existsSync(ffprobePath)) {
        console.warn('FFmpeg not found. Please ensure ffmpeg.exe and ffprobe.exe are in the app folder.');
    }
}
...
async function selectFiles(mode) {
    try {
        ...
        const filePaths = await ipcRenderer.invoke('select-files', filters);
